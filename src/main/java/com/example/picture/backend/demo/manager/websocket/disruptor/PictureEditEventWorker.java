package com.example.picture.backend.demo.manager.websocket.disruptor;

import cn.hutool.json.JSONUtil;
import com.example.picture.backend.demo.manager.websocket.PictureEditHandler;
...
import com.example.picture.backend.demo.manager.websocket.model.PictureEditResponseMessage;
...
@Slf4j
@Component
public class PictureEditEventWorker implements WorkHandler<PictureEditEvent> {
