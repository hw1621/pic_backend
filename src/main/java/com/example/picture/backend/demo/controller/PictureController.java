...
import com.example.picture.backend.demo.api.imagesearch.ImageSearchApiFacade;
import com.example.picture.backend.demo.api.imagesearch.model.ImageSearchResult;
...
public class PictureController {
    ...
    public BaseResponse<PictureVO> uploadPictureByUrl(HttpServletRequest request,
    ...
    public BaseResponse<Boolean> updatePicture(@RequestBody PictureUpdateRequest pictureUpdateRequest, HttpServletRequest request) {
        ...
        // 补充审核参数
        User loginUser = userService.getLoginUser(request);
        pictureService.fillReviewParam(oldPicture, loginUser);
    ...
    /**
     * Get picture dbased on id（Admin Only）
     */
    @GetMapping("/get")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    ...
    public BaseResponse<PictureVO> getPictureVOById(long id, HttpServletRequest request) {
        ...
        if (spaceId != null) {
            User loingUser = userService.getLoginUser(request);
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPage(@RequestBody PictureQueryRequest pictureQueryRequest,
        ...
        if (spaceId == null) {
            ...
            if (!loginUser.getId().equals(space.getUserId())) {
                throw new BusinessException(ErrorCode.NO_AUTH_ERROR, "No permission to access the space");
            }
        }
